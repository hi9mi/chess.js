...
describe('Check new methods', () => {
  ...
  it('checking piece count in fen, test fen', () => {
    ...
    const expected = [
      { startNumberPieces: 0, startOrientation: 'w' },
    ...
    validPositions.forEach((fen, index) => {
      const expectedPiecesCount =
        expected[index].startNumberPieces === 0
          ? false
          : expected[index].startNumberPieces
      const expectedPieceOrientation =
        expected[index].startNumberPieces === 0
          ? false
          : expected[index].startOrientation
